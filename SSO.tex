...
Opgaven undersøger Taylorpolynomier og deres historie, med særlig fokus på samtidens matematikere. Den kommer også ind på Taylorformlens restled, dens størrelse, samt Taylorpolynomiers praktiske anvendelser. \\
Opgaven beviser formlen for Taylorrækken, og undersøger Taylorpolynomiers Lagrange restled, hvilket også bevises.\\
Ved en analyse af Taylorpolynomierepresentationen for $\cos(\theta)$ undersøges fejlen ved at se bort fra restleddet, hvordan det påvirkes af Taylorpolynomiets grad, og hvordan det kan udregnes.\\
I diskussionen perspektiveres Taylorpolynomier ved, at overveje deres praktiske anvendelser. Opgaven peger på, at Taylorpolynomier stadig er relevante i dag. Den viser også  hvordan man finder frem til dem, og argumenterer at Taylorpolynomier er opkaldt på passende vis, set i et historisk lys.
\tableofcontents
\newpage
...
%\textcolor{red}{perspektivér ved at overveje praktiske anvendelser af ]synomier}
